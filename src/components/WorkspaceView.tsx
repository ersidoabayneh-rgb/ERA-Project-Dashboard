...
export default function WorkspaceView({ projects = [], onRestoreProjects, currentUserObj }: WorkspaceViewProps) {
  ...
  const isMasterAdmin = activeUser?.role === 'master_admin' || activeUser?.role === 'admin' || activeUser?.role === 'cpm_admin' || activeUser?.username === 'proj_1781786415663' || Boolean(activeUser?.username && activeUser.username.toLowerCase().includes('ersido'));
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Firebase Cloud Firestore Sync Manager Card - Restricted to Master Admin */}
            {isMasterAdmin && (
